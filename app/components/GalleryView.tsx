...
const GalleryView: React.FC<GalleryViewProps> = ({ selectedYear = '2025' }) => {
  ...
  useEffect(() => {
    ...
    const yearToImages: Record<string, Array<{url: string, caption: string}>> = {
      ...
      '2024': [
        { url: 'mela8.jpeg', caption: 'Cultural Showcase 2024' },
        { url: 'mela6.jpeg', caption: 'Mela 2024' },
      ...
      '2025': [
        { url: 'mela24.jpeg', caption: 'Cultural Showcase 2025' },
        { url: 'mela5.jpeg', caption: 'Mela  2025' },
        { url: 'chabeel3.jpeg', caption: 'Chabeel 2025' },
